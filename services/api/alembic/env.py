...
# Add the project root to sys.path to match the import structure used in the app
...
from services.api.src.database.db_models import BodyMeasurementTable, ExerciseTable, UserTable  # noqa: F401
