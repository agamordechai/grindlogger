...
Usage:
    # Test all tools
    uv run python mcp/probe.py

    # Test specific tool
    uv run python mcp/probe.py --tool list-exercises

    # Test with custom parameters
    uv run python mcp/probe.py --tool list-exercises --page 1 --page-size 5
"""
import sys
import json
...
from mcp.exercises_server import list_exercises, get_exercise, calculate_volume
